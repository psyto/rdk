...
1. **Lending precompile fuzz harness (E-3)** — proptest covers pure-compute; precompile boundary needs an adversarial-input fuzzer. Audit-prep work; targeted at Q4 2026.
2. **Precompile gas pricing (E-4)** — open question in the v0 lending plan. Resolution required before public testnet promotes to L1 mainnet.
